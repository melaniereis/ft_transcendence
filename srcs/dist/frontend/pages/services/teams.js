...
export function renderTeamsPage(container) {
    container.innerHTML = `
		<h2>Select a Team</h2>
		...
		<img src="assets/codealliance.png" alt="Code Alliance" class="team-img" data-team="code_alliance" />
		</div>`;
    const images = container.querySelectorAll('.team-img');
    images.forEach(img => {
