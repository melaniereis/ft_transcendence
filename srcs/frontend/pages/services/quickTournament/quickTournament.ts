...
export async function renderLocalTournamentPage(container: HTMLDivElement) {
    ...
    <input type="text" id="player1" placeholder="${t.player1Placeholder || 'Player 1 (You)'}" required maxlength="16"
      ...
      box-shadow:0 2px 8px rgba(44,34,84,0.08);margin-bottom:1rem;" />
    <input type="text" id="player2" placeholder="${t.player2Placeholder || 'Player 2'}" required maxlength="16"
      style="width:100%;padding:1.2rem;border:2px solid ${GRIS_COLORS.secondary};border-radius:1.2rem;
      background:rgba(255,255,255,0.98);color:${GRIS_COLORS.secondary};font-weight:700;font-size:1.05rem;
      box-shadow:0 2px 8px rgba(44,34,84,0.08);margin-bottom:1rem;" />
    <input type="text" id="player3" placeholder="${t.player3Placeholder || 'Player 3'}" required maxlength="16"
      style="width:100%;padding:1.2rem;border:2px solid ${GRIS_COLORS.secondary};border-radius:1.2rem;
      background:rgba(255,255,255,0.98);color:${GRIS_COLORS.secondary};font-weight:700;font-size:1.05rem;
      box-shadow:0 2px 8px rgba(44,34,84,0.08);margin-bottom:1rem;" />
    <input type="text" id="player4" placeholder="${t.player4Placeholder || 'Player 4'}" required maxlength="16"
      style="width:100%;padding:1.2rem;border:2px solid ${GRIS_COLORS.secondary};border-radius:1.2rem;
      background:rgba(255,255,255,0.98);color:${GRIS_COLORS.secondary};font-weight:700;font-size:1.05rem;
      box-shadow:0 2px 8px rgba(44,34,84,0.08);margin-bottom:1rem;" />
  ...
  `;
	...
	function validatePlayers() {
		...
		${names.map(n => `<li style="color:${GRIS_COLORS.primary};font-weight:700;font-size:clamp(12px,2.8vw,16px);">${n}</li>`).join('')}
        </ul>
      `;
		} else {
