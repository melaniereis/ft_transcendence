...
export async function startTournament(container: HTMLElement, tournament: any, selectedPlayers: any[],
	...
	const players = [
		{ id: player1_id, name: truncateName(await getUserName(player1_id)) },
		{ id: player2_id, name: truncateName(await getUserName(player2_id)) },
		{ id: player3_id, name: truncateName(await getUserName(player3_id)) },
		{ id: player4_id, name: truncateName(await getUserName(player4_id)) }
	];
