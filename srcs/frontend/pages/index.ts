...
// Background image per route
export function setBackgroundForRoute(route: string): void {
	const backgrounds: Record<string, string> = {
		'/play': 'url("https://geekculture.co/wp-content/uploads/2018/08/Screen-Shot-2018-08-14-at-12.03.49-PM.jpg")',
		'/settings': 'url("https://cdn.staticneo.com/ew/thumb/c/c8/Gris_Ch2-2_Kp08J.jpg/730px-Gris_Ch2-2_Kp08J.jpg")',
		'/tournaments': 'url("https://i0.wp.com/epiloguegaming.com/wp-content/uploads/2019/02/IMG_20190225_191501.jpg")',
		'/teams': 'url("https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/683320/ss_631d99cc6462cce94081032b7e600a6b87c3f7d3.1920x1080.jpg?t=1755285422")',
		'/friend-requests': 'url("https://assetsio.gnwcdn.com/gris-header.jpg")',
		'/matchmaking': 'url("https://assets.rockpapershotgun.com/images/2018/12/GRIS-a.jpg")',
		'default': 'url("https://images.gog-statics.com/2711f1155f42d68a57c9ad2fb755a49839e6bc17a22b4a0bc262b0e35cb73115.jpg")'
	};

	appDiv.style.transition = 'background-image 1s ease-in-out';
	appDiv.style.backgroundImage = backgrounds[route] || backgrounds['default'];
